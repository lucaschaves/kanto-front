...
import { PagePaymentsPvCreateOrEdit } from "./createOrEdit";
import { FilterPaymentsPv } from "./filter";
...
const PagePaymentsPv = () => {
    const { t } = useTranslation();

    const [stateColumns] = useState<ColumnDef<IPaymentPv>[]>(() => {
        const columns: any[] = [];
        const colsDef = [
...
export { FilterPaymentsPv, PagePaymentsPv, PagePaymentsPvCreateOrEdit };
